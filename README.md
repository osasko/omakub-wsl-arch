# Omakub-WSL-Arch (Omakub-MJ fork)

*** Kibado do AkitaOnRails(https://github.com/akitaonrails) ora fazer rodar no meu WSL Arch Linux ***
...
From a Terminal run:
    ...
    wget -qO- https://raw.githubusercontent.com/osasko/omakub-wsl-arch/stable/boot.sh | bash
